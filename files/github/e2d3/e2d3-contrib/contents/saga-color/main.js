 ...
 * Revised for Saga by horiyo on 16/05/26.
*/
...
d3.json(baseUrl + "/saga.topojson", function(error, o) {
...
function show(data)
{
  if (data && topo.objects)
  {
    ...
    {
      d.properties.data = {};
      d.properties.data = data[d.properties.cityName] || {};
    });
    ...
    topoSelection.on('mouseover', function(d)
    {
      ...
      tooltipTitle.text(d.properties.cityName);
